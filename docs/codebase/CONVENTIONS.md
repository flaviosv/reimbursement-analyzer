...
- **README:** `README.md` documents install/run/test/migrate at a high level; one line still states the migrations directory one path segment too deep (`src/api/src/api/migrations/` vs. the real `src/api/src/migrations/`) — see `CONCERNS.md`.
